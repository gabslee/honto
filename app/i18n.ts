...
export const messages = {
  en: {
    ...
    lobby: {
      ...
      writingTimer: "Writing timer", guessingTimer: "Guessing timer", enabled: "Enabled", theme: "Theme categories", mixed: "General", family: "Family", life: "Life stories", flirty: "Flirty", spicy: "Spicy · 18+", wild: "Wild", innocent: "Innocent & silly", selectSubjects: "Select any subjects you want in this game. Leave all unchecked for safe general themes.", exclusiveThemes: "Fresh themes", customTheme: "Your own subject", customThemePlaceholder: "e.g. our worst travel stories", gameMode: "Game mode", modeHonto: "Two Lies, One Truth", modeTruthSips: "Truth or Sips", truthOrDare: "Truth or Sips mini game",
