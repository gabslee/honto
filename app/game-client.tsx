...
type GameState = {
  room: { code: string; status: "lobby" | "playing" | "finished" | "abandoned"; roundCount: number; currentRound: number; themeCategory: string; customTheme: string | null; welcomeAck: string[]; locale: Locale; startedAt: string | null; canUseSpicy?: boolean };
